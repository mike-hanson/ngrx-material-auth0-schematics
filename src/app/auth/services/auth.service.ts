...
export class AuthService {
  ...
  public checkSessionObservable$ = bindNodeCallback(this.auth0WebAuth.checkSession.bind(this.auth0WebAuth));
  ...
  public checkSession$() {
    return this.checkSessionObservable$(Auth0Config);
  }
}
